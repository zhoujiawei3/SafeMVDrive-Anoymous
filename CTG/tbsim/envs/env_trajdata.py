...
class EnvUnifiedSimulation(BaseEnv, BatchedEnv):
    ...
    def get_info(self):
        ...
        if self._log_data:
            ...
            sim_buffer = [sim_buffer[k] for k in self.current_scene_index] #current_scene_index current_scene_split
    ...
    def set_first_time_prediction(self, action_positions, action_yaws,world_positions,world_yaws):
        #  17,100,1,2  17,100,1,1
        self.action_positions = action_positions.squeeze(axis=2)  #  17,100,2
        self.action_yaws = action_yaws.squeeze(axis=2)  #  17,100,1
        self.world_positions = world_positions#.squeeze(axis=2)  #  17,100,2
        self.world_yaws = world_yaws#.squeeze(axis=2)  #  17,100,1
        # 
