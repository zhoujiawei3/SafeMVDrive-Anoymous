...
class DiffuserConfig(AlgoConfig):
    def __init__(self):
        ...
        # }
class DiffuserConfig_based_current_on_lane(AlgoConfig):
    def __init__(self):
        super(DiffuserConfig_based_current_on_lane, self).__init__()
        self.eval_class = "Diffuser"
        ...
        self.disable_control_on_stationary = "on_lane" # ['any_speed', 'current_speed'. 'on_lane', False] vehicles (always stationary) will be forced to 0 during rollout (including denoising iteration)
        self.moving_speed_th = 5e-1 # speed threshold for determining if stationary
        ...
        self.history_num_frames = 1 # param to control the number of time steps to use for history
        self.history_num_frames_ego = self.history_num_frames
        self.history_num_frames_agents = self.history_num_frames
        ...
        #     'neighbor_hist': [( 0.225483, 0.344136, 0.112020, 0.107992, 0.054426,  ), ( 7.460583, 5.544016, 0.415600, 0.241769, 0.232373,  )],
        # }
class DiffuserConfig_based_current_false(AlgoConfig):
    def __init__(self):
        super(DiffuserConfig_based_current_false, self).__init__()
        self.eval_class = "Diffuser"
        ...
        self.disable_control_on_stationary = False # ['any_speed', 'current_speed'. 'on_lane', False] vehicles (always stationary) will be forced to 0 during rollout (including denoising iteration)
        self.moving_speed_th = 5e-1 # speed threshold for determining if stationary
