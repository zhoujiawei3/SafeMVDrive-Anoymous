import json
import random
with open("/home//VLM_attack_propose/annotation/mini-data_new_250_val_random3_bug_fix_before_20_frames_auto_label_test_false_current_speed_add_ego_V_add_noType_collide_question.json", "r") as f:
    datas = json.load(f)
...
with open("/home//VLM_attack_propose/annotation/mini-data_new_250_val_random3_bug_fix_before_20_frames_auto_label_test_false_current_speed_add_ego_V_add_noType_collide_question_only_no_type.json", "w") as f:
