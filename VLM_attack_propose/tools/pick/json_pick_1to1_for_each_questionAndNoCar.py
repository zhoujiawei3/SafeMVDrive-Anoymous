import json
import random
with open("/home//VLM_attack_propose/annotation/mini-data_new_100.json", "r") as f:
    datas = json.load(f)
...
with open("/home//VLM_attack_propose/annotation/mini-data_new_100_val_bev_pick.json", "w") as f:
