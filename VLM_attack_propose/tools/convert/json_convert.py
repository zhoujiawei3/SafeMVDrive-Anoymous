...
with open("/home//VLM_attack_propose/annotation/mini-data_100_val_random2_bug_fix_after6frames_auto_label_test.json", "r") as f:
    datas = json.load(f)
#datalist
USER_PROMPT = (
...
for i in range(len(datas)):
    ...
    question["value"]=USER_PROMPT+collision+". "+collisition_description[collision]
...
with open("/home//VLM_attack_propose/annotation/mini-data_new_100_val_random2_bug_fix_after6frames_auto_label_test_add_description.json", "w") as f:
