...
data=250
data_save_path="/home//VLM_attack_propose/annotation/mini-data_250_val_random3_bug_fix_before_20_frames.json"
...
while len(annotations)<data*5:
    ...
    if not os.path.exists('/home//VLM_attack_propose/example_bev_250_val_random3_bug_fix_before_20_frames/'):
        os.makedirs('/home//VLM_attack_propose/example_bev_250_val_random3_bug_fix_before_20_frames/')
    
    if  not os.path.exists('/home//VLM_attack_propose/example_rgb_250_val_random3_bug_fix_before_20_frames/'):
        os.makedirs('/home//VLM_attack_propose/example_rgb_250_val_random3_bug_fix_before_20_frames/')

    new_image.save('/home//VLM_attack_propose/example_rgb_250_val_random3_bug_fix_before_20_frames/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')
    # for i in range(6):
    ...
    bev_render.save_fig('/home//VLM_attack_propose/example_bev_250_val_random3_bug_fix_after6frames' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')

    meta_annotation['bev_path'] = '/home//VLM_attack_propose/example_bev_250_val_random3_bug_fix_before_20_frames/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
    meta_annotation['rgb_path'] = '/home//VLM_attack_propose/example_rgb_250_val_random3_bug_fix_before_20_frames/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
