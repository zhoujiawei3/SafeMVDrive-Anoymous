...
dataroot = '/data2//nuscenes_trainval_1.0'
...
data=1000
data_save_path="/home//VLM_attack_propose/annotation/mini-data_1000_continue_train_after6frames_random7_bug_fix.json"
already_data_path="/home//VLM_attack_propose/annotation/mini-data_500_new_train_after6frames_random7_bug_fix.json"
...
while len(annotations)<data*5:
    ...
    if not os.path.exists('/home//VLM_attack_propose/example_bev_1000_continue_train_after6frames_random7_bug_fix/'):
        os.makedirs('/home//VLM_attack_propose/example_bev_1000_continue_train_after6frames_random7_bug_fix/')
    
    if  not os.path.exists('/home//VLM_attack_propose/example_rgb_1000_continue_train_after6frames_random7_bug_fix/'):
        os.makedirs('/home//VLM_attack_propose/example_rgb_1000_continue_train_after6frames_random7_bug_fix/')

    new_image.save('/home//VLM_attack_propose/example_rgb_1000_continue_train_after6frames_random7_bug_fix/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')
    # for i in range(6):
    ...
    bev_render.save_fig('/home//VLM_attack_propose/example_bev_1000_continue_train_after6frames_random7_bug_fix' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')

    meta_annotation['bev_path'] = '/home//VLM_attack_propose/example_bev_1000_continue_train_after6frames_random7_bug_fix/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
    meta_annotation['rgb_path'] = '/home//VLM_attack_propose/example_rgb_1000_continue_train_after6frames_random7_bug_fix/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
