...
data=100
data_save_path="/home//VLM_attack_propose/annotation/mini-data_100_bev_revise.json"
...
for i in range(data):
    ...
    output_scene_number=random.choice(range(700))
    scene = nuscenes.scene[output_scene_number]

    output_sample_number=random.choice(range(scene['nbr_samples']-1))
    ...
    if not os.path.exists('/home//VLM_attack_propose/example_bev/'):
        os.makedirs('/home//VLM_attack_propose/example_bev/')
    
    if  not os.path.exists('/home//VLM_attack_propose/example_rgb/'):
        os.makedirs('/home//VLM_attack_propose/example_rgb/')

    new_image.save('/home//VLM_attack_propose/example_rgb/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')
    # for i in range(6):
    ...
    bev_render.save_fig('/home//VLM_attack_propose/example_bev/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')

    meta_annotation['bev_path'] = '/home//VLM_attack_propose/example_bev/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
    meta_annotation['rgb_path'] = '/home//VLM_attack_propose/example_rgb/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
