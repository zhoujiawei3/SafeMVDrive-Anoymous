...
data=500
data_save_path="/home//VLM_attack_propose/annotation/mini-data_500_train_after6frames_random2_bug_fix_for_vis.json"
...
while len(annotations)<data*5:
    ...
    # output_scene_number=random.choice(train_list)
    output_scene_number=754
    scene = nuscenes.scene[output_scene_number]
    #

    # output_sample_number=random.choice(range(5,scene['nbr_samples']-1))
    output_sample_number=25
    ...
    for i,file in enumerate(file_list):
        ...
        for label,anno in anno_need_to_render_dict.items():
            ...
            if y1 - 42.85 >= 0:
                ...
                text_bbox = draw.textbbox((x1, y1 - 42.85), label_text, font)
                ...
                # 
                draw.text((x1, y1-text_height-25.71), label_text, fill="white", font=font)
            else:
                #  textbbox  bounding box
                text_bbox = draw.textbbox((x1, y1 + 42.85), label_text, font)
                text_width = text_bbox[2] - text_bbox[0]  # 
                ...
                # 
                draw.text((x1, y1-25.71), label_text, fill="white", font=font)
    ...
    if not os.path.exists('/home//VLM_attack_propose/example_bev_500_new_train_after6frames_random2_bug_fix_vis/'):
        os.makedirs('/home//VLM_attack_propose/example_bev_500_new_train_after6frames_random2_bug_fix_vis/')
    
    if  not os.path.exists('/home//VLM_attack_propose/example_rgb_500_new_train_after6frames_random2_bug_fix_vis/'):
        os.makedirs('/home//VLM_attack_propose/example_rgb_500_new_train_after6frames_random2_bug_fix_vis/')

    new_image.save('/home//VLM_attack_propose/example_rgb_500_new_train_after6frames_random2_bug_fix_vis/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')
    # for i in range(6):
    ...
    bev_render.save_fig('/home//VLM_attack_propose/example_bev_500_new_train_after6frames_random2_bug_fix_vis/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg')

    meta_annotation['bev_path'] = '/home//VLM_attack_propose/example_bev_500_new_train_after6frames_random2_bug_fix_vis/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
    meta_annotation['rgb_path'] = '/home//VLM_attack_propose/example_rgb_500_new_train_after6frames_random2_bug_fix_vis/' + output_dataset + '_'+str(output_scene_number)+'_'+str(output_sample_number)+'.jpg'
