...
def create_parser():
    ...
    parser.add_argument(
        "-c", "--config-path", type=str, default="/home//OpenDWM/configs/unimlvg/generate_preview.json",
        help="The config to load the dataset.")
    parser.add_argument(
        "-o", "--output-path", type=str, default="/data3//OpenDWM_output/preview_dataset_collision",
